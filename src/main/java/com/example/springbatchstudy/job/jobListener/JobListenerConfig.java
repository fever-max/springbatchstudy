package com.example.springbatchstudy.job.jobListener;
...
public class JobListenerConfig {
    ...
    public Job jobListenerJob(Step jobListenerStep) {
        return jobBuilderFactory.get("jobListenerStep")
    ...
    public Tasklet jobListenerTasklet() {
        return new Tasklet() {
            ...
            public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
                System.out.println("Jop Listener Tasklet");
                return RepeatStatus.FINISHED;
                // throw new Exception("실패 체크");
            }
        };
    }
